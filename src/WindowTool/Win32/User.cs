...
namespace Win32
{
    ...
    public class User
    {
        ...
        public static extern IntPtr ChildWindowFromPointEx(IntPtr hwnd, int xPoint, int yPoint, int un);
        ...
        [DllImport("user32",EntryPoint ="WindowFromPoint")] public static extern int WindowFromPoint(int xPoint, int yPoint);
